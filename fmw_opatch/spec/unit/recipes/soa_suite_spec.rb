...
describe 'fmw_opatch::soa_suite' do
  ...
  context 'Missing soa patch file, on CentOS platform' do
    ...
    let(:chef_run) do
      runner = ChefSpec::ServerRunner.new(platform: 'centos', version: '6.6') do |node|
        ...
        node.set['fmw_wls']['source_file']             = '/software/fmw_12.1.3.0.0_infrastructure.jar'
        node.set['fmw_inst']['soa_suite_source_file']  = '/software/fmw_12.1.3.0.0_soa_Disk1_1of1.zip'
        node.set['fmw_opatch']['soa_suite_patch_id']  = '20423408'
      end
      runner.converge(described_recipe)
    end
  ...
  context 'Missing soa patch id, on CentOS platform' do
    ...
    let(:chef_run) do
      runner = ChefSpec::ServerRunner.new(platform: 'centos', version: '6.6') do |node|
        ...
        node.set['fmw_wls']['source_file']               = '/software/fmw_12.1.3.0.0_infrastructure.jar'
        node.set['fmw_inst']['soa_suite_source_file']    = '/software/fmw_12.1.3.0.0_soa_Disk1_1of1.zip'
        node.set['fmw_opatch']['soa_suite_source_file']  = '/software/p20423408_121300_Generic.zip'
      end
      runner.converge(described_recipe)
    end
  ...
  context 'With all attributes, 10.3.6, on CentOS platform' do
    ...
    let(:chef_run) do
      runner = ChefSpec::ServerRunner.new(platform: 'centos', version: '6.6') do |node|
        ...
        node.set['fmw_opatch']['soa_suite_patch_id']     = '20423535'
        node.set['fmw_opatch']['soa_suite_source_file']  = '/software/p20423535_111170_Generic.zip'
      end
      runner.converge(described_recipe)
    end
  ...
  context 'With all attributes 12.1.3, on Windows platform' do
    ...
    let(:chef_run) do
      runner = ChefSpec::ServerRunner.new(platform: 'windows', version: '2012R2', step_into: ['fmw_inst_fmw_extract_windows','fmw_inst_fmw_install_windows']) do |node|
        ...
        node.set['fmw_opatch']['soa_suite_patch_id']     = '20423408'
        node.set['fmw_opatch']['soa_suite_source_file']  = 'c:\\software\\p20423408_121300_Generic.zip'
      end
      runner.converge(described_recipe)
    end
  ...
  context 'With all attributes 10.3.6, on Windows platform' do
    ...
    let(:chef_run) do
      runner = ChefSpec::ServerRunner.new(platform: 'windows', version: '2012R2', step_into: ['fmw_inst_fmw_extract_windows','fmw_inst_fmw_install_windows']) do |node|
        ...
        node.set['fmw_opatch']['soa_suite_patch_id']     = '20423535'
        node.set['fmw_opatch']['soa_suite_source_file']  = 'c:\\software\\p20423535_111170_Generic.zip'
      end
      runner.converge(described_recipe)
    end

...
# Resource:: repository
#
provides :fmw_rcu_repository, os: [ 'linux', 'solaris2']
...
state_attrs :java_home_dir, :middleware_home_dir, :db_connect_url, :jdbc_connect_url, :db_connect_user, :rcu_prefix, :rcu_components, :os_user, :os_group, :tmp_dir

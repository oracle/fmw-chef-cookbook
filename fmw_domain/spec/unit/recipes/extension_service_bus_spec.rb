...
describe 'fmw_domain::extension_service_bus' do
  ...
  context 'When all attributes are default, 12.1.3, on CentOS' do 
    ...
    it 'converges successfully' do
      ...
      expect(chef_run).to create_template('/tmp/service_bus.py').with(
        ...
        variables:  {
          ...
          :tmp_dir=>"/tmp", 
          :version=>"12.1.3", 
          :wls_em_template=>"/opt/oracle/middleware_xxx/em/common/templates/wls/oracle.em_wls_template_12.1.3.jar", 
          :wls_sb_template=>"/opt/oracle/middleware_xxx/osb/common/templates/wls/oracle.osb_template_12.1.3.jar", 
          :wls_ws_template=>"/opt/oracle/middleware_xxx/oracle_common/common/templates/wls/oracle.wls-webservice-template_12.1.3.jar", 
          :osb_server_startup_arguments=>"-XX:PermSize=512m -XX:MaxPermSize=512m -Xms1024m -Xmx1024m -Djava.security.egd=file:/dev/./urandom", 
          :bam_cluster=>"", 
          :osb_cluster=>"", 
          :ess_cluster=>"", 
          :soa_cluster=>"", 
      ...
      expect(chef_run).to execute_fmw_domain_wlst('WLST add service_bus domain extension').with(
        script_file: '/tmp/service_bus.py',
  ...
  context 'When all attributes are default, 12.1.3, on Windows' do 
    ...
    it 'converges successfully' do
      ...
      expect(chef_run).to create_template('C:/temp/service_bus.py').with(
        source: 'domain/extensions/service_bus.py',
        variables:  
          {
            ...
            :wls_sb_template=>"c:\\oracle\\middleware_xxx/osb/common/templates/wls/oracle.osb_template_12.1.3.jar", 
            :wls_ws_template=>"c:\\oracle\\middleware_xxx/oracle_common/common/templates/wls/oracle.wls-webservice-template_12.1.3.jar", 
            :osb_server_startup_arguments=>"-XX:PermSize=512m -XX:MaxPermSize=512m -Xms1024m -Xmx1024m", 
            :bam_cluster=>"", 
            :osb_cluster=>"", 
            :ess_cluster=>"", 
            :soa_cluster=>"", 
      ...
      expect(chef_run).to execute_fmw_domain_wlst('WLST add service_bus domain extension').with(
        script_file: 'C:/temp/service_bus.py',
        ...
        variables: 
          {
            ...
            :wls_sb_template=>"/opt/oracle/middleware_xxx/Oracle_OSB1/common/templates/applications/wlsb.jar", 
            :wls_ws_template=>"/opt/oracle/middleware_xxx/wlserver_10.3/common/templates/applications/wls_webservice.jar", 
            :osb_server_startup_arguments=>"-XX:PermSize=512m -XX:MaxPermSize=512m -Xms1024m -Xmx1024m -Djava.security.egd=file:/dev/./urandom", 
            :bam_cluster=>"", 
            :osb_cluster=>"", 
            :ess_cluster=>"", 
        ...
        variables:  
          {
            ...
            :wls_sb_template=>"c:\\oracle\\middleware_xxx/Oracle_OSB1/common/templates/applications/wlsb.jar", 
            :wls_ws_template=>"c:\\oracle\\middleware_xxx\\wlserver_10.3/common/templates/applications/wls_webservice.jar", 
            :osb_server_startup_arguments=>"-XX:PermSize=512m -XX:MaxPermSize=512m -Xms1024m -Xmx1024m", 
            :bam_cluster=>"", 
            :osb_cluster=>"", 
            :ess_cluster=>"", 

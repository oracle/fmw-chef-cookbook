...
describe 'fmw_domain::domain' do
  ...
  describe file('/usr/jdk/instances/jdk1.8.0_131') do
    it { should be_directory }
    it { should be_owned_by 'root' }
  end

  describe file('/usr/jdk/instances/jdk1.8.0_131/bin/java') do
    it { should be_file }
    it { should be_owned_by 'root' }
  ...
  describe file('/usr/bin/java') do
    ...
    it { should be_linked_to '/usr/jdk/instances/jdk1.8.0_131/bin/java' }
  end
  ...
  describe file('/opt/oracle/middleware_1213/user_projects/domains/base') do
    it { should be_directory }
    it { should be_owned_by 'oracle' }
    it { should be_grouped_into 'oinstall' }
  end

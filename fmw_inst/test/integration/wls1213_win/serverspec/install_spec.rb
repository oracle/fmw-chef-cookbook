...
describe 'fmw_inst::install' do
  ...
  describe file('C:/oracle/middleware_1213/oracle_common/bin/rcu.bat') do
    it { should be_file }
  end

  describe file('C:/oracle/middleware_1213/soa/bin') do
    it { should be_directory }
  end

  describe file('C:/oracle/middleware_1213/osb/bin') do
    it { should be_directory }
  end

...
if ['12.2.1', '12.1.3'].include?(node['fmw']['version'])
...
if ['10.3.6', '12.1.3', '12.2.1'].include?(node['fmw']['version'])
  fmw_inst_fmw_extract 'soa_suite' do
    action              :extract
    source_file         node['fmw_inst']['soa_suite_source_file']
    source_2_file       node['fmw_inst']['soa_suite_source_2_file'] unless node['fmw_inst'].attribute?('soa_suite_source_2_file')
